...
sh "xcodebuild clean build -workspace SeriesManager.xcworkspace -scheme SeriesManager -destination 'platform=iOS Simulator,name=iPhone 5s' VALID_ARCHS=x86_64 test | xcpretty"
